...
type options struct {
	TLSSource          string        `long:"tls-source" env:"TT_TLS_SOURCE" choice:"letsencrypt" choice:"self-signed" choice:"provided" description:"Certificate source for initial setup"`
	...
	TLSCertificateFile string        `long:"tls-certificate-file" env:"TT_TLS_CERTIFICATE_FILE" description:"Read-only PEM chain for provided TLS"`
	TLSKeyFile         string        `long:"tls-key-file" env:"TT_TLS_KEY_FILE" description:"Read-only PEM key for provided TLS"`
...
func run(args []string) error {
	...
	cfg := app.Config{
		...
		TLSSource: certificate.Source(opts.TLSSource), TLSCertificateFile: opts.TLSCertificateFile, TLSKeyFile: opts.TLSKeyFile,
